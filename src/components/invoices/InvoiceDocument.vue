...
const invoiceDate = computed(() => {
  const date = props.order.completedAt || props.order.createdAt
...
<template>
  <article class="invoice-document">
    ...
    <header class="invoice-header">
      <div class="company">
        <div class="company-logo">DDS</div>

        <div class="company-info">
          <h1>Digital Distribution Solutions</h1>

          <p>Nairobi, Kenya</p>

          <p>info@example.com · +254 XXX XXX XXX</p>
        </div>
      </div>
    ...
    <section class="customer-section">
      ...
      <div class="customer-details">
        ...
        <p v-if="customer?.city || customer?.region">
          {{ customer?.city }}<span v-if="customer?.city && customer?.region">, </span
          >{{ customer?.region }}
        </p>
        ...
        <p v-if="customer?.vatNumber">VAT No. {{ customer.vatNumber }}</p>
      </div>
    </section>
    ...
    <section class="totals-section">
      <div class="totals">
        <div class="total-row">
          ...
          <span>
            {{
              formatCurrency(items.reduce((total, item) => total + Number(item.lineTotal || 0), 0))
            }}
          </span>
        </div>
    ...
    <!-- Notes -->
    <section v-if="order.notes" class="notes-section">
