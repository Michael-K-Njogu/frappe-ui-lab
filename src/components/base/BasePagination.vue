...
<template>
  <div class="pagination">
    ...
    <div class="pagination-controls">
      <button class="btn btn-md btn-secondary" :disabled="!hasPrevious" @click="goToPreviousPage">
        Previous
      </button>

      <span class="pagination-page-info"> Page {{ currentPage }} of {{ totalPages }} </span>

      <button class="btn btn-md btn-secondary" :disabled="!hasNext" @click="goToNextPage">
        Next
      </button>
    </div>
  </div>
